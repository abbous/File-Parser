export declare type CreateRows = (obj: AnyObject, elem: any, index: number) => AnyObject;
export declare type CreateColumns = (stack: string[], elem: string, index: number) => string[];
